...
3. B/S架构？
   ...
   - B/S结构的系统优点和缺点是：
     ...
     - 缺点：
       ...
       - 体验差（界面不是那么酷炫，因为浏览器只支持三个语言HTML CSS JavaScript，并且再加上速度慢。）
...
![BS结构系统的通信原理2](Servlet-JSP-课堂笔记.assets/BS结构系统的通信原理2.png)
...
![BS结构系统的角色和协议](Servlet-JSP-课堂笔记.assets/BS结构系统的角色和协议.png)
...
<img src="Servlet-JSP-课堂笔记.assets/image-20230130004733870.png" alt="image-20230130004733870" style="zoom:80%;" />    
...
- 思考：我们自己new的Servlet对象受WEB容器的管理吗？
  ...
  - ![WEB容器中的Map集合](Servlet-JSP-课堂笔记.assets/WEB容器中的Map集合.png) 
...
![BS结构系统的通信原理](Servlet-JSP-课堂笔记.assets/BS结构系统的通信原理.png)
...
![请求路径和XXXServlet之间应该有一个对照关系](Servlet-JSP-课堂笔记.assets/请求路径和XXXServlet之间应该有一个对照关系.png)
